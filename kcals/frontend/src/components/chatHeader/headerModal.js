...
function HeaderModal(props) {
    ...
    const uploadModal = hidden ? null : <UploadModal setHidden={setHidden} setHeaderHidden={props.handleUserModal}/>
    ...
    return (
        <div id='modal-back-users' onClick={props.handleUserModal}>
            <div className={`modal-users ${sessionUser.darkMode ? 'modal-users-dark' : ''}`} onClick={stopProp}>
                <div id='pfp-name'>
                ...
                <div className="user-modal-options">
                    <h2 id='logout' onClick={()=>setHidden(false)}>Upload Profile Photo</h2>
